...
fun GestionarCitasScreen(
    idMedico: String, onBack: () -> Unit, viewModel: GestionCitasViewModel = viewModel()
) {
    ...
    // DIALOG CREAR
    if (showCrearDialog) {
        FormCitaDialog(titulo = "Crear nueva cita", citaInicial = Cita(
            Id_usuario = "",
            Id_medico = idMedico,
            Id_centroMedico = "",
            fecha = "",
...
@Composable
fun FormCitaDialog(
    titulo: String, citaInicial: Cita, onDismiss: () -> Unit, onSubmit: (Cita) -> Unit
) {
